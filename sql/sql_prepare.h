...
class Prepared_statement final {
 ...
 private:
  ...
  bool insert_params_from_vars(THD *thd, List<LEX_STRING> &varnames, String *query);
  bool insert_params(THD *thd, String *query, PS_PARAM *parameters);
};
