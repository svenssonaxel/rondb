...
void *Pool_context::alloc_page19(Uint32 type_id,
                           Uint32 *i,
...
void *Pool_context::alloc_page27(Uint32 type_id,
                           Uint32 *i,
                           bool allow_use_spare) {
  return m_block->m_ctx.m_mm.alloc_page(type_id, i,
...
void *Pool_context::alloc_page30(Uint32 type_id,
                           Uint32 *i,
                           bool allow_use_spare) {
  return m_block->m_ctx.m_mm.alloc_page(type_id, i,
...
void *Pool_context::alloc_page32(Uint32 type_id,
                           Uint32 *i,
                           bool allow_use_spare) {
  return m_block->m_ctx.m_mm.alloc_page(type_id, i,
