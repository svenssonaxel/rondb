...
void Dbtup::tuxGetTupAddr(Uint32 pageId, Uint32 pageIndex,
...
AttributeOffset::getOffset(attrDes2
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
AttributeOffset::getOffset(
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 Dbtup::tuxReadAttrs(EmulatedJamBuffer *jamBuf, Uint32 fragPtrI,
...
int Dbtup::mt_scan_next(Uint32 tableId, Uint64 fragPtrI, Local_key *pos,
                        bool moveNext) {
  TablerecPtr tablePtr;
  tablePtr.i = tableId;
  ptrCheckGuard(tablePtr, cnoOfTablerec, tablerec);
