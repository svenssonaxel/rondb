...
void Dbdict::execDBINFO_SCANREQ(Signal *signal) {
  ...
  switch (req.tableId) {
    ...
    case Ndbinfo::STORED_TABLES_TABLEID: case Ndbinfo::TABLE_MAP_TABLEID:
  {
      jam();
...
bool packRopeData(SimpleProperties::Writer &w, LcConstRope &rope) {
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 &rh = AlterTableReq::getNameFlag(impl_req->changeMask)
...
void Dbdict::map_fk_columns(Ptr<ForeignKeyRec> fk_ptr,
...
void
Dbdict::createFK_writeTableConf(Signal *signal, Uint32 op_key,
                                     Uint32 ret) {
...
bool Dbdict::seizeTxHandle(TxHandlePtr &tx_ptr, bool allow_fail) {
