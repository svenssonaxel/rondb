...
<<<<<<< RonDB // RONDB-624 todo
||||||| Common ancestor
DEB_START_RES(arglist) do { } while (0)
#endif

#ifdef 
// RONDB-624 todo: Glue these lines together ^v
=======
DEB_START_RES(arglist) \
  do {                         \
  } while (0)
#endif
...
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
g_eventLogger->info arglist ; } while (0)
#else
// RONDB-624 todo: Glue these lines together ^v
=======
                          \
...
Uint32 Restore::calculate_hash(Uint32 tableId,
                        const Uint32 *src,
