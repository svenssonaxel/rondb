...
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
very quick provided the fragment
// RONDB-624 todo: Glue these lines together ^v
=======
very quick provided the fragment
    //
...
>>>>>>> MySQL 8.0.36
 ...
 private:
  ...
  bool check_node_recovery_timers(Uint32 nodeId,    NodeRecord::NodeRecoveryStatus);
 ...
 private:
  ...
  void make_table_use_new_replica(Signal*,
                                  TabRecordPtr,
                                  FragmentstorePtr fragPtr, Uint32 primaryNode,
                                  ReplicaRecordPtr, Uint32 replicaType,
                                  Uint32 destNodeId);
  void make_table_use_new_node_order(Signal*,
                                     TabRecordPtr, FragmentstorePtr, Uint32,
                                     Uint32 *);
  ...
  bool findStartGci(ReplicaRecordPtr fstReplicaPtr, Uint32 tfstStopGci,
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 *fragPtr, Uint32 nodes[],
                         bool crash_on_error = true);
  Uint32 findLocalFragment(const TabRecord *, FragmentstorePtr &fragPtr,
                           EmulatedJamBuffer *jambuf);
...
#define DIH_CDATA_SIZE _SYSFILE_FILE_SIZE
  ...
  void add_nodes_to_fragment(Uint16 *fragments, Uint32 &node_index,
                             Uint32 &count, Uint32 partitions_per_node,
