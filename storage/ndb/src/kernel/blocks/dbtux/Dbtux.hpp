...
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
ScanOp&, Uint32 scanInstance, Frag&, bool need_lock =
// RONDB-624 todo: Glue these lines together ^v
=======
Signal
// RONDB-624 todo: Glue these lines together ^v
...
inline Dbtux::DescPage::DescPage() : m_numFree(ZNIL) {
...
inline void Dbtux::getTupAddr(TreeEnt ent, Uint32 &lkey1,
                              Uint32 &lkey2) {
  const TupLoc tupLoc = ent.m_tupLoc;
  c_tup->tuxGetTupAddr(tupLoc.getPageId(),
