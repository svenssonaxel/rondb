...
>>>>>>> MySQL 8.0.36
 log
     * This status specifies whether this fragment 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
is
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
checkTransaction(TcConnectionrecPtr
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
getHashKey(UintR
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
=======
void removeLogTcrec(const TcConnectionrec
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 *tcPtrP,
...
||||||| Common ancestor
TcConnectionrec *regTcPtr);
  int  findTransaction(UintR
// RONDB-624 todo: Glue these lines together ^v
=======
LogPartRecord *logPartPtrP);
  Uint32 returnExecLog(Signal
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 *signal, TcConnectionrecPtr,
...
>>>>>>> MySQL 8.0.36
  ...
  void seizePageRef(PageRefRecordPtr 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
  UintR Transid2,
// RONDB-624 todo: Glue these lines together ^v
...
||||||| Common ancestor
TcConnectionrecPtr& tcConnectptr);
  void getFirstInLogQueue(Signal*
// RONDB-624 todo: Glue these lines together ^v
=======
startNextExecSr(Signal *signal);
  void startTimeSupervision(Signal
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
...
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
getIndexTupFragPtrI(Uint32 tableId,
                           Uint32 fragId,
                           Uint64 & tupIndexFragPtrI,
                           Uint64 & tupTableFragPtrI);
private:
  void initialiseAddfragrec
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
initialiseFragrec
// RONDB-624 todo: Glue these lines together ^v
...
>>>>>>> MySQL 8.0.36
  ...
  void writeLogWords(Signal *signal, const Uint32 *data, Uint32 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
            Uint32 & freeEntry
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
moveToPageRef(LogFileOperationRecordPtr lfoPtr,
                     LogFileRecordPtr logFilePtr
// RONDB-624 todo: Glue these lines together ^v
=======
                  LogPartRecord *logPartPtrP);
...
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
void readExecSrNewMbyte(Signal*
// RONDB-624 todo: Glue these lines together ^v
=======
void writeFileInInvalidate(Signal
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 void exitFromInvalidate(Signal *signal, LogPartRecord *
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
logPartPtr
// RONDB-624 todo: Glue these lines together ^v
...
(Signal *signal);
  ...
  void moreconnectionsLab(Signal 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
             LogPartRecord *logPartPtrP);
  ...
  void openSrFourthPhaseLab(Signal* signal,
                            LogFileRecordPtr logFilePtr,
                            LogPartRecord *logPartPtrP);
  void openSrFourthZeroSkipInitLab(Signal
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
             LogPartRecord *logPartPtrP);
  void writeCommitLog(Signal* signal,
...
/*THAT CONNECTIONS ARE SET-UP TO THE NEW NODE.                               */
  ...
  /* -------------------------------------------------------------------------
   */
  /* These variable is used to keep track of what time we 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
have
// RONDB-624 todo: Glue these lines together ^v
...
/* -------------------------------------------------------------------------
  ...
  /* -------------------------------------------------------------------------
   */
  /*THIS VARIABLE CONTAINS MY OWN PROCESSOR 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
ID.                             
// RONDB-624 todo: Glue these lines together ^v
...
#define TRANSID_HASH_SIZE 131072
 ...
 public:
  ...
  struct CommitAckMarker {
    ...
    inline Uint32 hashValue() const { return transid1 ^ (transid2 >> 12); }
  };
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 is the total amount of outstanding words we
   * are allowed to handle in all 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
copy
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
sendFireTrigConfTc(Signal*
// RONDB-624 todo: Glue these lines together ^v
=======
sendFireTrigConfTc(Signal
// RONDB-624 todo: Glue these lines together ^v
...
private:
 ...
 private:
  ...
  void get_table_frag_instance(Uint32 tableId,   Uint32 fragId,   Uint32 & instanceNo);
