...
<<<<<<< RonDB // RONDB-624 todo
||||||| Common ancestor
abortParallelQueueOperation(Signal*
// RONDB-624 todo: Glue these lines together ^v
=======
abortParallelQueueOperation(Signal
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
                        OperationrecPtr op,          Uint32 hash);
...
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
check_lock_upgrade(Signal* signal,
// RONDB-624 todo: Glue these lines together ^v
=======
*/
// RONDB-624 todo: Glue these lines together ^v
...
||||||| Common ancestor
bool getfragmentrec(FragmentrecPtr&,
// RONDB-624 todo: Glue these lines together ^v
=======
FragmentrecPtr
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 FRAGMENT IDENTIIES WILL BE CALCULATED, AND TWO FRAGMENTS WILL
   * BE    */
...
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
signal, OperationrecPtr lockOwnerPtr);
  void
// RONDB-624 todo: Glue these lines together ^v
=======
TABREC
...
*/
 ...
 public:
  ...
  void release_frag_mutex_hash(Fragmentrec *fragPtrP, Uint32 inx) {
    if (qt_likely(globalData.ndbMtQueryWorkers > 0)) {
#if defined(VM_TRACE) || defined(ERROR_INSERT)
      jam();
      jamLine(Uint16(inx));
...
inline bool Dbacc::check_expand_shrink_ongoing(Uint64 fragPtrI) {
