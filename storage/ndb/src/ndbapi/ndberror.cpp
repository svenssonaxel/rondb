...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
, HA_ERR_NO_CONNECTION, UR, "No data node(s) ever connected, check firewall and cluster state"},
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
, HA_ERR_NO_CONNECTION, UR, "Data node(s) are in single user mode, cluster not ready"},
    {4012, DMEC, UR,
    ...
    {711,  HA_ERR_LOCK_WAIT_TIMEOUT, NR,
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
, HA_ERR_LOCK_WAIT_TIMEOUT, OL, "REDO buffers overloaded (increase RedoBuffer)"},
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
, HA_ERR_LOCK_WAIT_TIMEOUT, NR,
     "Connect failure in scan - most likely a 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
node failure
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
, DMEC, TR, "Cannot execute index stats update"},
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
, DMEC, TR, "Cannot prepare index stats update, out of prepare records"},
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
, DMEC, TR, "Cannot prepare index stats update, out of prepare pages"},
    ...
    {773, DMEC, SE,
     "Out of SchemaMemory, please modify SchemaMemory config parameter"},
