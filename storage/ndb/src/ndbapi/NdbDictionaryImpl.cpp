                                         ...
                                         NdbImpl *impl_ndb)
{
   ...
   * change the settings of primary 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
nodes. However readers
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
idx)
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 To ensure consistency we check
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 the wrong data node as transaction
   * coordinator. 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
We
...
=======
BaseString NdbIndexImpl::old_internal_index_name(
>>>>>>> MySQL 8.0.36
 of primary replicas 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
...
=======
>>>>>>> MySQL 8.0.36
 data structures for this function
   */
...
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
NdbOptimizeTableHandleImpl::init(Ndb*
// RONDB-624 todo: Glue these lines together ^v
=======
NdbOptimizeTableHandleImpl::init(Ndb
// RONDB-624 todo: Glue these lines together ^v
...
int NdbIndexImpl::setName(const char *name) { return !m_externalName.assign(name); }

const char * 
NdbIndexImpl::getName() const { return m_externalName.c_str(); }
 
int
NdbIndexImpl::setTableName(const 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
char *
// RONDB-624 todo: Glue these lines together ^v
...
>>>>>>> MySQL 8.0.36
 if (m_trans->execute(NdbTransaction::NoCommit) != 0) {
        if (m_trans->getNdbError().status == NdbError::TemporaryError)     continue;  /* goto next_retry */
        m_ndb->getNdbError(m_trans->getNdbError().code);
        goto do_error;
      }
      break;
...
int NdbOptimizeTableHandleImpl::init(Ndb* ndb, const 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
NdbTableImpl
// RONDB-624 todo: Glue these lines together ^v
...
>>>>>>> MySQL 8.0.36
,
                                              we only optimize var part, then if the
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 = m_table->m_columns.size(); i > 0 && blob_num > 0;) {
    i--;
...
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
NdbOptimizeTableHandleImpl::INITIALIZED)
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
signal,
// RONDB-624 todo: Glue these lines together ^v
...
=======
>>>>>>> MySQL 8.0.36
  assert("Failed to restart transaction"));
      m_ndb->closeTransaction(m_trans);
      m_trans = nullptr;
...
// RONDB-624 todo: Glue these lines together ^v
=======
NdbApiSignal *sig, LinearSectionPtr ptr[3],
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
_state(NdbOptimizeIndexHandleImpl::CREATED),
...
int NdbOptimizeIndexHandleImpl::next()
{
  ...
  if (m_index->m_facade->getType() != NdbDictionary::Index::UniqueHashIndex) DBUG_RETURN(0);
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
(m_optimize_table_handle.m_impl.close());
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
_ENTER("NdbEventImpl::setTable(const NdbDictionary::Table *table)");
  if (table == nullptr)
  {
...
// RONDB-624 todo: Glue these lines together ^v
=======
CAST_CONSTPTR(GetTabInfoConf, signal
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
->execDROP_FILEGROUP_REF(signal);
    break;
...
<<<<<<< RonDB // RONDB-624 todo
||||||| Common ancestor
DictTabInfo::AllNodesMediumTable,
// RONDB-624 todo: Glue these lines together ^v
=======
 {DictTabInfo::AllNodesMediumTable,
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
::find_next(len, nbm, i + 1))
  
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
||||||| Common ancestor
DictTabInfo::SingleFragment,
// RONDB-624 todo: Glue these lines together ^v
=======
 {DictTabInfo::SingleFragment,
// RONDB-624 todo: Glue these lines together ^v
...
<<<<<<< RonDB // RONDB-624 todo
||||||| Common ancestor
DictTabInfo::DistrKeyLin,
// RONDB-624 todo: Glue these lines together ^v
=======
 {DictTabInfo::DistrKeyLin,
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
     // NdbDictInterface only cares 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
about
// RONDB-624 todo: Glue these lines together ^v
...
>>>>>>> MySQL 8.0.36
 mod);
#ifdef VM_TRACE
      g_eventLogger->info("retry sleep 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
%ums
// RONDB-624 todo: Glue these lines together ^v
...
>>>>>>> MySQL 8.0.36
   /*
      The PollGuard has an implicit call 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
of
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
DictTabInfo::StateOffline,
// RONDB-624 todo: Glue these lines together ^v
=======
 {DictTabInfo::StateOffline,
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 This method is called implicitly by the compiler
...
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
DictTabInfo::StateDropping,
// RONDB-624 todo: Glue these lines together ^v
=======
 {DictTabInfo::StateDropping,
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 out of context due to a return,
...
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
DictTabInfo::ObsoleteStateBackup,NdbDictionary::Object::StateOnline },
// RONDB-624 todo: Glue these lines together ^v
=======
 {DictTabInfo::ObsoleteStateBackup,
     NdbDictionary::Object::StateOnline},
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 */
...
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
getTransporter()->get_an_alive_node()));
||||||| Common ancestor
DictTabInfo::StorePermanent,
// RONDB-624 todo: Glue these lines together ^v
=======
 {DictTabInfo::StorePermanent,
// RONDB-624 todo: Glue these lines together ^v
...
=======
(NdbDictionary::Object::FragmentType)getApiConstant(
>>>>>>> MySQL 8.0.36
...
int
NdbDictionaryImpl::optimizeTable(const NdbTableImpl 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
&t,
||||||| Common ancestor
...
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
DBUG_ENTER("NdbDictionaryImpl::optimizeTableGlobal(const
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
NdbTableImpl*
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 sure that hashmap exists (i.e after upgrade or similar)
       */
...
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
WrongPartitionBalanceFullyReplicated
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
t)
{
...
=
>>>>>>> MySQL 8.0.36
          CreateHashMapReq::CreateDefault |            NdbTableImpl &impl)
{
...
NdbDictionaryImpl::alterBlobTables(const NdbTableImpl & old_tab,
                                   const NdbTableImpl & new_tab,         Uint32 tabChangeMask)
{
...
>>>>>>> MySQL 8.0.36
 ||
   NdbTableImpl &impl, impl.m_fully_replicated != old_impl.m_fully_replicated)
  ...
  */
  {
    ...
    for (Uint32 i = 0; i <impl.m_fd.size(); i++)   tmpTab->FragmentData[i] = (Uint16)src[i];
  }
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
->MaxLoadFactor = impl.m_maxLoadFactor;
...
fragmentType,
=======
fragmentType, fragmentTypeMapping,
>>>>>>> MySQL 8.0.36
...
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
byteSize = col->m_defaultValue.length();
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
NdbTableImpl::IndirectWriter,
// RONDB-624 todo: Glue these lines together ^v
...
||||||| Common ancestor
=======
&tmpAttr, DictTabInfo::AttributeMapping,
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 WAIT_ALTER_TAB_REQ,                         signal->getDataPtr());
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 & NdbDictionary::Dictionary::DropTableCascadeConstraints)
  {
...
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
"info", ("col %s: blob table pointer is NULL",
// RONDB-624 todo: Glue these lines together ^v
=======
"info",
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 the new hash is supported by this version.",
                           ix.getIndexTable()->getName(),
                           tab.getName()));
  }
