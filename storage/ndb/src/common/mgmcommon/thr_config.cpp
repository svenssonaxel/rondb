...
>>>>>>> MySQL 8.0.36
 "
   Uint32 num_recover_threads_only = recover_threads 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
-
// RONDB-624 todo: Glue these lines together ^v
...
||||||| Common ancestor
=======
ldm_threads, query_threads, recover_threads,
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 main_threads, rep_threads,
    add(T_RECOVER, realtime, 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
spintime
// RONDB-624 todo: Glue these lines together ^v
...
int THRConfig::handle_spec(const char *str, unsigned realtime,
  ...
  do {
    ...
    if (values[IX_NOSEND].found &&
        !(type == T_LDM || type == T_TC || type == T_RECV ||
          type == T_QUERY ||
