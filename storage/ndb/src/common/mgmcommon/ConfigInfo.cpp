...
const ConfigInfo::ParamInfo ConfigInfo::m_ParamInfo[] = {
...

  {
    ...
    {CFG_DB_AUTO_MEMORY_CONFIG, "AutomaticMemoryConfig", DB_TOKEN,
     "Memory configuration fully automated",
     ConfigInfo::CI_USED, false, ConfigInfo::CI_BOOL, "true", "false", "true"},

    {CFG_DB_TOTAL_MEMORY_CONFIG, "TotalMemoryConfig", DB_TOKEN, "Avoid using this amount of memory by data node",
     ConfigInfo::CI_USED, false, ConfigInfo::CI_INT64, "0", "2G",
    "65536G" },

    {CFG_DB_OS_STATIC_OVERHEAD, "OsStaticOverhead", DB_TOKEN, "Avoid using this amount of memory by data node",
     ConfigInfo::CI_USED, false, ConfigInfo::CI_INT64, "1400M", "400M",
    "65536G" },

    {CFG_DB_OS_CPU_OVERHEAD, "OsCpuOverhead", DB_TOKEN,
     "Avoid using this amount of memory multiplied by number of CPUs",
     ConfigInfo::CI_USED, false, ConfigInfo::CI_INT64, "100M", "50M",
    "65536G" },

    {CFG_DB_TRANSACTION_MEM, "TransactionMemory", DB_TOKEN,
     "Number bytes on each " DB_TOKEN_PRINT
     " node allocated for operations",
     ConfigInfo::CI_USED, false, ConfigInfo::CI_INT64, "0", "0",
    "65536G" },

    {CFG_DB_SCHEMA_MEM, "SchemaMemory", DB_TOKEN,
     "Number bytes on each " DB_TOKEN_PRINT
     " node allocated for schema"
    " objects",
     ConfigInfo::CI_USED, false, ConfigInfo::CI_INT64, "0", "0", "16384G"},

    {CFG_DB_BACKUP_SCHEMA_MEM, "BackupSchemaMemory", DB_TOKEN,
...
>>>>>>> MySQL 8.0.36
  {CFG_DB_BACKUP_LOG_BUFFER_MEM, "BackupLogBufferSize", DB_TOKEN,
    ...
    {CFG_DB_STRING_MEMORY, "StringMemory", DB_TOKEN,
     ...
     ConfigInfo::CI_USED, false, ConfigInfo::CI_INT, STR_VALUE(DEFAULT_STRING_MEMORY), "0",
     STR_VALUE(MAX_INT_RNIL)},
  ...
  /****************************************************************************
    ...
    {KEY_INTERNAL, "wan", MGM_TOKEN, "Use WAN TCP setting as default",
     ConfigInfo::CI_USED, false, ConfigInfo::CI_BOOL, "false",
    "false",
    "true"
  },
