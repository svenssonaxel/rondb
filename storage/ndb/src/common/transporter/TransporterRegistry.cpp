...
void TransporterRegistry::disconnectAll() {
  DEBUG_FPRINTF(
      (stderr, "(Node %u)doDisconnect(all), line: %d\n", localNodeId, __LINE__));
                                  ...
                                  const char *new_hostname)
{
  ...
  {
    if (theTCPTransporters[i]->remoteNodeId 
    ...
    if (theSHMTransporters[i]->remoteNodeId == nodeId)
    {
      DEBUG_FPRINTF((stderr,
        "set_hostname(Node %u) = %s on SHM trp: %u, trp: %u\n",     nodeId,     new_hostname,
                    i,     theSHMTransporters[i]->getTransporterIndex()));
  ...
  */
  ...
  if (multi_trp && multi_transporter_instance > 0) {
    ...
    if (!multi_trp) {
      ...
      {
        g_eventLogger->info("Crash: connect_server: node: %u, 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
state:
// RONDB-624 todo: Glue these lines together ^v
...
>>>>>>> MySQL 8.0.36
  ...
  if (!correct_state)
  {
    DBUG_PRINT("error", ("Transporter for Node %d in wrong state %s",         nodeId, msg.c_str()));
...
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
TCP_Transporter(*this,
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
SHM_Transporter(*this,
...
[[maybe_unused]]) {
#ifdef NDB_SHM_TRANSPORTER_SUPPORTED
  DBUG_ENTER("TransporterRegistry::createTransporter
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
...
>>>>>>> MySQL 8.0.36
      ...
      SHM_Transporter *new_trp = new 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
SHM_Transporter(*this, shm_trp);
...
=======
>>>>>>> MySQL 8.0.36
  localNodeId,   require(new_trp->initTransporter());
      multi_trp->add_not_used_trp(new_trp);
      new_trp->set_multi_transporter_instance(i + 1);
 ...
 * the receiver transporter disconnect 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
/ reconnect by both
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
=======
require(signalHeader->m_noOfSections
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 == 0);
  const Packer::LinearSectionArg section(nullptr);
...
bool TransporterRegistry::setup_recv_wakeup_socket(
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 num_trps = nTCPTransporters + nSHMTransporters 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
...
+
>>>>>>> MySQL 8.0.36
 to add extra sock %u to epoll-set: %u", sock,
             (m_has_extra_wakeup_socket ? 1 : 0);

    if (num_trps) {
      tcpReadSelectReply =
          epoll_wait(recvdata.m_epoll_fd, recvdata.m_epoll_events,            error);
      goto err;
    }
  }
#endif
...
Uint32
TransporterRegistry::poll_SHM(TransporterReceiveHandle&
// RONDB-624 todo: Glue these lines together ^v
=======
retVal;
}

Uint32 TransporterRegistry::poll_SHM(TransporterReceiveHandle
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
...
Uint32 TransporterRegistry::poll_SHM(TransporterReceiveHandle& recvdata [[maybe_unused]],
                              bool &any_connected) {
  assert((receiveHandle == &recvdata) || (receiveHandle == nullptr));
...
/
int
TransporterRegistry::reset_shm_awake_state(TransporterReceiveHandle&
// RONDB-624 todo: Glue these lines together ^v
=======
/
...
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
However if we reached a situation
...
*/
void
TransporterRegistry::set_shm_awake_state(TransporterReceiveHandle&
// RONDB-624 todo: Glue these lines together ^v
=======
*/
void TransporterRegistry::set_shm_awake_state(TransporterReceiveHandle
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 ...
 * we actually is still on our way to go to sleep. 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
In
// RONDB-624 todo: Glue these lines together ^v
...
*/
Uint32
TransporterRegistry::performReceive(TransporterReceiveHandle&
// RONDB-624 todo: Glue these lines together ^v
=======
*/
Uint32 TransporterRegistry::performReceive(TransporterReceiveHandle
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
...
<<<<<<< RonDB // RONDB-624 todo
    ...
    for (Uint32 j = 0; j < recvdata.nSHMTransporters; j++)
    {
       ...
       * wake up, so we're not
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
// Full, can't unpack more
        }
...
=======
>>>>>>> MySQL 8.0.36
 interested in the data as such.
       * But to integrate it with epoll 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
handling
// RONDB-624 todo: Glue these lines together ^v
...
||||||| Common ancestor
=======
(unlikely(recvdata.m_handled_transporters.get(trp_id)))
>>>>>>> MySQL 8.0.36
      SHM_Transporter * t = 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
theSHMTransporters[j];
||||||| Common ancestor
=======
continue;
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
(recvdata.m_socket_poller.has_read(idx[i]))
||||||| Common ancestor
node_id,
=======
>>>>>>> MySQL 8.0.36
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 szUsed = unpack(recvdata, ptr, sz, node_id,   }
      }
      i++;
    }
#endif
...
<<<<<<< RonDB // RONDB-624 todo
||||||| Common ancestor
m_blocked.get(nodeId);
}

void
TransporterRegistry::blockReceive(TransporterReceiveHandle&
// RONDB-624 todo: Glue these lines together ^v
=======
m_blocked.get(nodeId);
}

void TransporterRegistry::blockReceive(TransporterReceiveHandle
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
...
void
TransporterRegistry::unblockReceive(TransporterReceiveHandle&
// RONDB-624 todo: Glue these lines together ^v
=======
}

void TransporterRegistry::unblockReceive(TransporterReceiveHandle
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
...
>>>>>>> MySQL 8.0.36
   " in state: %d",
        node_id, send_source ? "send" : "recv", errnum,   stopReceiving);
...
*/
void
TransporterRegistry::report_connect(TransporterReceiveHandle&
// RONDB-624 todo: Glue these lines together ^v
=======
*/
void TransporterRegistry::report_connect(TransporterReceiveHandle
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
...
=======
DEBUG_FPRINTF(
        (stderr, "(%u)performStates[%u] = CONNECTED\n", localNodeId, node_id));
...
<<<<<<< RonDB // RONDB-624 todo
 let's take care of
       ...
       * ignore calling epoll_wait again as long
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
 node_id));
    performStates[node_id] = CONNECTED;
...
>>>>>>> MySQL 8.0.36
 as we haven't served
       * all transporters seen in the 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
previous epoll
// RONDB-624 todo: Glue these lines together ^v
...
localNodeId,
>>>>>>> MySQL 8.0.36
 while (ret == sizeof(buf) || (ret == -1 && err == 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
EINTR
// RONDB-624 todo: Glue these lines together ^v
...
>>>>>>> MySQL 8.0.36
  ...
  if (t != nullptr) {
    ...
    require(!t->isMultiTransporter());
    DEBUG_FPRINTF((stderr,
                                       "(Node %u)REG:resetBuffers(Node %u)\n",
                           localNodeId, node_id));
    t->resetBuffers();
  }
 ...
 *
 * Next the transporter buffers are sent, this requires 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
holding the
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
well as the send mutex when moving the buffers to the
...
%d", nodeId,
>>>>>>> MySQL 8.0.36
 on the socket. The verification of this client
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 handle the authentication protocol where
 ...
 * that will enable it to verify that the connect is ok to perform 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
at
// RONDB-624 todo: Glue these lines together ^v
 ...
 * be picked by this method independent of if it connected 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
as
// RONDB-624 todo: Glue these lines together ^v
 ...
 * disconnectImpl on the transporter that will close 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
the
// RONDB-624 todo: Glue these lines together ^v
...
>>>>>>> MySQL 8.0.36
 socket and
 * ensure that the variable theSocket no longer points to a 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
valid
||||||| Common ancestor
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 again protected by the send mutex and the receive
 * mutex to ensure that it doesn't 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
happen
// RONDB-624 todo: Glue these lines together ^v
...
if (res >= 0) {
>>>>>>> MySQL 8.0.36
 Here we will also close the socket.
 *
 ...
 * responsible for receiving on this transporter.
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
		if (server_port != 0)
                {
...
>>>>>>> MySQL 8.0.36
 TRPMAN instance. This signal will be
 ...
 * receiving a signal from another node that the 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
node is dead.
 * In this case QMGR
...
number
>>>>>>> MySQL 8.0.36
 will send CLOSE_COMREQ to TRPMAN instances and
 * TRPMAN will 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
set the IO state
...
=======
>>>>>>> MySQL 8.0.36
 to HaltIO to ensure no more signals
 * 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
are
...
=======
>>>>>>> MySQL 8.0.36
 call do_disconnect in TransporterRegistry
 * to ensure that the above close sequence is 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
called
// RONDB-624 todo: Glue these lines together ^v
 ...
 * data nodes as well. For API nodes we already have 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
the ability to
 * use multiple transporters from
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
...
=======
  DBUG_PRINT("info",
>>>>>>> MySQL 8.0.36
 an application program by using
 ...
 * between the nodes is happening 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
as
// RONDB-624 todo: Glue these lines together ^v
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 transporters can only be used between data nodes
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 unlockMultiTransporters. This mutex 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
should
||||||| Common ancestor
...
=======
   break;
>>>>>>> MySQL 8.0.36
 transporter is slightly different since 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
we
// RONDB-624 todo: Glue these lines together ^v
...
=======
>>>>>>> MySQL 8.0.36
 the ACTIVATE_TRP_REQ signal can
 * be processed 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
in
...
using port %d",
>>>>>>> MySQL 8.0.36
 receiving node. When all ACTIVATE_TRP_REQ have
 * been processed we can 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
send
// RONDB-624 todo: Glue these lines together ^v
...
=======
>>>>>>> MySQL 8.0.36
 ACTIVATE_TRP_CONF to the requesting node.
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 ACTIVATE_TRP_REQ from the other node, then we are ready
...
size
>>>>>>> MySQL 8.0.36
 the base transporter will cause do_disconnect to be called
 * on this transporter while the 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
node
// RONDB-624 todo: Glue these lines together ^v
 ...
 * mutex before changing theSocket here. Since the 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
transporter
// RONDB-624 todo: Glue these lines together ^v
...
bool
TransporterRegistry::start_service(SocketServer&
// RONDB-624 todo: Glue these lines together ^v
=======
DBUG_VOID_RETURN;
}

bool TransporterRegistry::start_service(SocketServer
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
...
&socket_server) {
>>>>>>> MySQL 8.0.36
 as calling doDisconnect on the
...
<<<<<<< RonDB // RONDB-624 todo
||||||| Common ancestor
_server.setup(transporter_service, &addr))
...
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 with :performReceive() on the same recvdata. Thus,
 * it must either be 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
called
...
=======
Ndb_combine_address_port(
>>>>>>> MySQL 8.0.36
 from the same (receive-)thread as
 * performReceive(), or protected by acquiring 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
the (client) poll rights.
 */
Uint32
TransporterRegistry::update_connections(TransporterReceiveHandle& recvdata,
...
transporter_service;
>>>>>>> MySQL 8.0.36
 during CONNECTING -> we are still DISCONNECTED 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
*/
...
void TransporterRegistry::get_trps_for_node(NodeId nodeId,
...
=======
>>>>>>> MySQL 8.0.36
     Uint32 lenBytes,    Uint32 max_size) {
  Transporter *t = theNodeIdTransporters[nodeId];
  if (!t) {
    num_ids = 0;
  }
...
void TransporterRegistry::set_active_node(Uint32 node_id,
                                     Uint32 active,
                                     bool log)
{
  if (active == 0)
...
bool
TransporterRegistry::isMultiTransporter(Transporter*
// RONDB-624 todo: Glue these lines together ^v
=======
t->getTransporterIndex();
}

bool TransporterRegistry::isMultiTransporter(Transporter
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
