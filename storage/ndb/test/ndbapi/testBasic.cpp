...
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
runOneNoCommitEarlyError(NDBT_Context*
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
runNoCommit626(NDBT_Context*
// RONDB-624 todo: Glue these lines together ^v
=======
>>>>>>> MySQL 8.0.36
...
GETNDB(step);
  ...
  do{
    ...
    CHECK(hugoOps.startTransaction(pNdb)
// RONDB-624 todo: Glue these lines together ^v
=======
...
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
CHECK(hugoOps.execute_NoCommit(pNdb)
// RONDB-624 todo: Glue these lines together ^v
=======
>>>>>>> MySQL 8.0.36
...
=======
CHECK(hugoOp2.execute_async_prepare(pNdb,
// RONDB-624 todo: Glue these lines together ^v
>>>>>>> MySQL 8.0.36
 NdbTransaction::NoCommit) == 0);
