...
int testPKUpdateWithSetValue(NDBT_Context *ctx, NDBT_Step *step) {
  ...
  //////////////////////////////////////////////////////////
  // Test using either update(i==0) or 
  ...
  while (true) {
    ...
    while (true) {
      ...
      if (hugoOps.execute_Commit(otherNdb) != 0) {
        ...
        {
          /* Expected scenario due to injected 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
sleep(4);
||||||| Common ancestor
...
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
g_err.println("FragApiFail
// RONDB-624 todo: Glue these lines together ^v
||||||| Common ancestor
g_info.println("FragApiFail
// RONDB-624 todo: Glue these lines together ^v
=======
>>>>>>> MySQL 8.0.36
       * connection
...
int runBug51775(NDBT_Context *ctx, NDBT_Step 
// RONDB-624 todo: Glue these lines together ^v
<<<<<<< RonDB // RONDB-624 todo
||
