...
static struct my_option my_long_options[] = {
    ...
    {"restore_data", 'r',
     "Restore table data/logs into RonDB using NDBAPI", &_restore_data,
     nullptr, nullptr, GET_BOOL, NO_ARG, 0, 0, 0, 0, 0, 0},
    {"restore_meta", 'm', "Restore meta data into RonDB using NDBAPI",
    ...
    (uchar**) &ga_continue_on_data_errors, 0, GET_BOOL, NO_ARG, 0, 0, 0, 0,
     0, 0},
    {"allow-unique-indexes", NDB_OPT_NOSHORT,
    "Attempt to restore despite unique indexes are present and 
