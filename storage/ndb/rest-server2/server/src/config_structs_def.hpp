...
(APIKey,
 ...
 PROBLEM(cacheRefreshIntervalMS <= 0, "cache refresh interval must be greater than 0")
 PROBLEM(cacheUnusedEntriesEvictionMS <= 0, "cache unused entries eviction must be greater than 0")
